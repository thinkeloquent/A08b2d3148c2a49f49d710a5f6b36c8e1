 ...
 *
 * Alias endpoints mirroring gemini_openai_embedding.route.mjs under a different base path.
...
const BASE_PATH = '/api/llm/gemini-openai-embedding-v1-router';
const _openaiEnv = resolveOpenaiEnv();
const _TAG = '[embedding-router-route]';
