...
async def get_async_redis_client(config: RedisConfig | None = None) -> AsyncRedis:
...
def get_sync_redis_client(config: RedisConfig | None = None) -> redis.Redis:
...
async def check_connection(config: RedisConfig | None = None) -> bool:
...
async def check_connection_status(config: RedisConfig | None = None) -> dict:
