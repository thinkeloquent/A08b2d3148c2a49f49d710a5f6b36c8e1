...
from env_resolver import resolve_postgresql_env
...
class PostgresConfig:
    ...
    ssl_ca_file: str | None = field(default=None)
    ...
    def __init__(
        ...
        db_url_env = resolve_postgresql_env().url
        if db_url_env:
    ...
    def _parse_database_url(self, url: str) -> None:
        ...
        try:
            ...
            raise DatabaseConfigError(f"Invalid DATABASE_URL: {e}") from e
    ...
    def validate(self) -> None:
        ...
        try:
            ...
            raise DatabaseConfigError(f"Configuration validation failed: {str(e)}") from e
