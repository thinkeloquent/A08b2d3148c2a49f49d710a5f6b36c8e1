...
import { Building, Edit, Trash2, Calendar, User } from 'lucide-react';
          ...
          <div className="flex items-start justify-between">
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 font-mono mt-1">{organization.slug}</p>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="mt-2 text-gray-900">
                {organization.description || <span className="text-gray-400 italic">No description provided</span>}
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6 pt-4 border-t border-gray-200">
              <div>
                ...
                <p className="mt-1 text-sm text-gray-900">{format(new Date(organization.createdAt), 'PPP')}</p>
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-gray-900">{format(new Date(organization.updatedAt), 'PPP')}</p>
                <p className="text-xs text-gray-500 flex items-center mt-1">
                  <User className="h-3 w-3 mr-1" />
