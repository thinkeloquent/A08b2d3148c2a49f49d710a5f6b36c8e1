...
fastify.log.info('✓ Group Role Management plugin registered');
...
const start = async () => {
  try {
    ...
    fastify.log.info('🚀 Starting Group Role Management Server...');
    ...
    fastify.log.info(`✓ API endpoint: http://localhost:${port}/api/group-role-management`);
