# Group Role Management Protocol Buffers
...
```javascript
import { Repository, RepositoryType } from '@internal/group_role_management-proto';
...
```typescript
import type { Repository, RepositoryType } from '@internal/group_role_management-proto';
