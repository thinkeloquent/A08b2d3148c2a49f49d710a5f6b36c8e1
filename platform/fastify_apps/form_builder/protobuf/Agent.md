...
```javascript
import { Repository, RepositoryType } from '@internal/form_builder-proto';
...
```typescript
import type { Repository, RepositoryType } from '@internal/form_builder-proto';
