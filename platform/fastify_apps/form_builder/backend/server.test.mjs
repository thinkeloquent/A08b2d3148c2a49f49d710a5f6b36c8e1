...
await fastify.register(fastifyStatic, {
  ...
  prefix: '/static/app/form-builder/frontend/dist/',
});
...
fastify.log.info('✓ Form Builder plugin registered');
...
const start = async () => {
  try {
    ...
    fastify.log.info('🚀 Starting Form Builder Server...');
    fastify.log.info(
      {
        port,
        host,
    ...
    fastify.log.info(`✓ API endpoint: http://localhost:${port}/api/form-builder`);
