...
await fastify.register(fastifyStatic, {
  ...
  prefix: '/static/app/app-figma-files/frontend/dist/',
});
...
fastify.log.info('✓ App Figma Files plugin registered');
...
const start = async () => {
  try {
    ...
    fastify.log.info('Starting App Figma Files Server...');
    fastify.log.info(
      {
        port,
        host,
    ...
    fastify.log.info(`✓ API endpoint: http://localhost:${port}/api/figma-files`);
