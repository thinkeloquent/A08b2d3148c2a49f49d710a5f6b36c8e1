    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 mt-1">Manage figma file categorization tags</p>
        </div>
        <Link
          to="/tags/new"
      ...
      <ConfirmDialog
        ...
        title="Delete Tag"
        message={`Are you sure you want to delete the tag "${tagToDelete?.name}"? This will remove it from all figma files.`}
        confirmText="Delete"
        variant="danger"
