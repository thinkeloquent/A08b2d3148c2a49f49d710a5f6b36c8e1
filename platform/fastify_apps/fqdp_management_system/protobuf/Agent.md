# Fqdp Management System Protocol Buffers
...
```protobuf
syntax = "proto3";
package fqdp_management_system;
...
```javascript
import { Repository, RepositoryType } from '@internal/fqdp_management_system-proto';
...
```typescript
import type { Repository, RepositoryType } from '@internal/fqdp_management_system-proto';
