...
async function databasePlugin(fastify, _options) {
  // Check if db decorator already exists with required models (provided by lifecycle)
  if (fastify.hasDecorator('db') && fastify.db?.sequelize && fastify.db?.ComponentDefinition && fastify.db?.ComponentTag) {
