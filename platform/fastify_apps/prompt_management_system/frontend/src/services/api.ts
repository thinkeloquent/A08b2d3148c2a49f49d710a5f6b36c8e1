...
export const versionsApi = {
  ...
  update: (promptId: string, versionId: string, data: Record<string, unknown>) =>
    fetchApi<PromptVersion>(`/prompts/${promptId}/versions/${versionId}`, {
      method: 'PUT',
      body: JSON.stringify(data),
    }),
  updateStatus: (promptId: string, versionId: string, status: 'draft' | 'published' | 'archived' | 'disabled') =>
    fetchApi<PromptVersion>(`/prompts/${promptId}/versions/${versionId}/status`, {
      method: 'PATCH',
