# Prompt Management System Protocol Buffers
...
```protobuf
syntax = "proto3";
package prompt_management_system;
...
```javascript
import { Repository, RepositoryType } from '@internal/prompt_management_system-proto';
...
```typescript
import type { Repository, RepositoryType } from '@internal/prompt_management_system-proto';
