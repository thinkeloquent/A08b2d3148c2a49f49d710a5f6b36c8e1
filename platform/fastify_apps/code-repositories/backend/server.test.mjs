...
await fastify.register(fastifyStatic, {
  ...
  prefix: '/static/app/app-code-repos/frontend/dist/',
});
...
fastify.log.info('✓ App Code Repos plugin registered');
...
const start = async () => {
  try {
    ...
    fastify.log.info('🚀 Starting App Code Repos Server...');
    fastify.log.info(
      {
        port,
        host,
    ...
    fastify.log.info(`✓ API endpoint: http://localhost:${port}/api/app-code-repos`);
