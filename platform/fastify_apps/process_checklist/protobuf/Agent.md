# Process Checklist Protocol Buffers
...
```javascript
import { Repository, RepositoryType } from '@internal/process_checklist-proto';
...
```typescript
import type { Repository, RepositoryType } from '@internal/process_checklist-proto';
