...
import type { CreateTemplateRequest, Step } from '../../types';
...
export function TemplateCreatePage() {
  ...
  const validate = (): boolean => {
    ...
    if (!templateId.trim()) errs.templateId = 'Template ID is required';
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-gray-500">
          Define a new process checklist template with steps
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="bg-white border border-gray-200 rounded-lg p-6 space-y-4" data-test-id="div-6af2abfa">
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6 space-y-4" data-test-id="div-289e2317">
        ...
        <div className="flex justify-end gap-3" data-test-id="div-e479d620">
          <Link
            to="/templates"
