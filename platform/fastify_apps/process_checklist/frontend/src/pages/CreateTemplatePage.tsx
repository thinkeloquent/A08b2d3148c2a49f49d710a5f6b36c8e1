    ...
    <PageShell>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        <Card
          ...
          description="Basic details that identify and describe this template." data-test-id="card-db642c45">
        ...
        <Card
          title="Steps"
          description="Define the individual tasks that make up this template. Add each step one at a time." data-test-id="card-dafbb522">
        ...
        <div className="flex flex-wrap gap-4" data-test-id="div-85ac094c">
          <button
            type="submit"
