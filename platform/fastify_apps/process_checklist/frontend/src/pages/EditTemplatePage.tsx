    ...
    <PageShell>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        <Card
          ...
          description="Basic details that identify and describe this template." data-test-id="card-52de32f0">
        ...
        <Card
          title="Steps"
          description="Define the individual tasks that make up this template. Add each step one at a time." data-test-id="card-2edd359a">
        ...
        <div className="flex flex-wrap gap-4" data-test-id="div-b0d51a4e">
          <button
            type="submit"
