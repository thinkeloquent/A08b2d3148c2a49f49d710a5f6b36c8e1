# Conditional Control Logic Viewer Protocol Buffers
...
```javascript
import { Repository, RepositoryType } from '@internal/conditional_control_logic_viewer-proto';
...
```typescript
import type { Repository, RepositoryType } from '@internal/conditional_control_logic_viewer-proto';
