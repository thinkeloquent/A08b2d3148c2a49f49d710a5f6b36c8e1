...
/**
 * Serialize a single Session model to API response shape.
 *
 * @param {object} model - Sequelize Session instance (or plain object)
 * @returns {object}
 */
...
/**
 * Serialize an array of Session models.
 *
 * @param {object[]} models
 * @returns {object[]}
 */
