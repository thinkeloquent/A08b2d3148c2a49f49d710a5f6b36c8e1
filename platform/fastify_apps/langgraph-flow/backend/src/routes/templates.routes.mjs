...
export default async function templateRoutes(fastify, _options) {
   ...
   * NOTE: Declared before GET /templates/:id so the literal "slug" segment
   * is not consumed by the :id param.
  ...
  /**
   * Update an existing template. Builtin templates cannot be modified.
   * PUT /templates/:id
   */
