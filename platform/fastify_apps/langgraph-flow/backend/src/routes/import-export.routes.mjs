...
export default async function importExportRoutes(fastify, _options) {
    ...
    schema: {
      ...
      body: {
        ...
        properties: {
          json: {
            type: 'string',
            description: 'JSON string of the flow to import',
          },
          format: {
            type: 'string',
            enum: ['native', 'flowise', 'langflow'],
            default: 'native',
            description: 'Source format of the JSON payload',
          },
        },
      },
    },
  ...
  /**
   * Export a flow to a requested format.
   * GET /flows/:id/export
   */
    ...
    schema: {
      ...
      querystring: {
        ...
        properties: {
          format: {
            type: 'string',
            enum: ['native', 'flowise', 'langflow', 'mermaid'],
            default: 'native',
