...
export default async function nodeRoutes(fastify, _options) {
  ...
  /**
   * Update a node within a flow.
   * Supports renaming: if id changes, all edge/condition references are rewired.
   ...
   * Removes all edges and conditions that reference the deleted node.
