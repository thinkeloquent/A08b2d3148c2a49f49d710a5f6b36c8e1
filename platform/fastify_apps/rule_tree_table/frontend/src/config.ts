...
export const config = {
  apiBaseUrl: import.meta.env.VITE_API_BASE_URL || '/~/api/rule_tree_table',
  ...
  basePath: import.meta.env.VITE_BASE_PATH || window.INITIAL_STATE?.basePath || '/apps/rule_tree_table',
} as const;
