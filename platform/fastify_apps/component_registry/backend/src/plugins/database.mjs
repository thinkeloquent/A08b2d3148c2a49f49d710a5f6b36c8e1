 ...
 * This plugin adds the component-registry models to that decorator.
...
async function databasePlugin(fastify, _options) {
  ...
  if (fastify.hasDecorator('db') && fastify.db?.sequelize) {
    ...
    fastify.log.info('Extending lifecycle db decorator with component-registry models');
...
export default fastifyPlugin(databasePlugin, {
  name: 'component-registry-database',
});
