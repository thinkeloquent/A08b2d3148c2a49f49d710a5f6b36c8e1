...
fastify.log.info('✓ Component Registry plugin registered');
...
const start = async () => {
  try {
    ...
    fastify.log.info('🚀 Starting Component Registry Server...');
    ...
    fastify.log.info(`✓ API endpoint: http://localhost:${port}/api/component-registry`);
