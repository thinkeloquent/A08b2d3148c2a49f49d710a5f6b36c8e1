# Component Registry Protocol Buffers
...
```javascript
import { Repository, RepositoryType } from '@internal/component_registry-proto';
...
```typescript
import type { Repository, RepositoryType } from '@internal/component_registry-proto';
