# Figma Component Inspector Protocol Buffers
...
```javascript
import { Repository, RepositoryType } from '@internal/figma_component_inspector-proto';
...
```typescript
import type { Repository, RepositoryType } from '@internal/figma_component_inspector-proto';
