...
export class RedisConfig {
    constructor(options = {}) {
        ...
        this.useSsl = resolveBool(options.useSsl, ['REDIS_SSL', 'REDIS_USE_SSL', 'REDIS_USE_TLS', 'REDIS_TLS'], options, 'useSsl', DEFAULT_CONFIG.useSsl);
    ...
    getTlsConfig() {
        if (!this.useSsl) return undefined;
