  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      <header className="bg-white shadow-sm border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-4 py-4" data-test-id="div-56570481">
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-4 py-8">
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6" data-test-id="div-eea42cab">
        ...
        <div className="mt-8 bg-white rounded-lg shadow-sm border border-gray-200 p-6" data-test-id="div-7aa7b68a">
      ...
      <footer className="bg-white border-t border-gray-200 py-4">
        <div className="max-w-4xl mx-auto px-4 text-center text-sm text-gray-500" data-test-id="div-46b7e408">
