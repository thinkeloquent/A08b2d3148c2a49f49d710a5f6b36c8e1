  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white shadow-sm border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-4 py-4" data-test-id="div-f7478eb3">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        {/* API Status Card */}
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6" data-test-id="div-b3f4235c">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6" data-test-id="div-6d926225">
      ...
      <footer className="bg-white border-t border-gray-200 mt-auto py-4">
        <div className="max-w-4xl mx-auto px-4 text-center text-sm text-gray-500" data-test-id="div-57b86930">
