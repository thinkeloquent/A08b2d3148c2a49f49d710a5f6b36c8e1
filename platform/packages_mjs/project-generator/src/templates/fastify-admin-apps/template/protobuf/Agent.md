# {{APP_NAME_TITLE}} Protocol Buffers
...
```javascript
import { Repository, RepositoryType } from '@internal/{{APP_NAME_SNAKE}}-proto';
...
```typescript
import type { Repository, RepositoryType } from '@internal/{{APP_NAME_SNAKE}}-proto';
