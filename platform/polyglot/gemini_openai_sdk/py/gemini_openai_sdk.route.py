...
from gemini_openai_sdk.constants import ROUTE_PREFIX
...
def mount(app: FastAPI):
    ...
    async def structure(request: Request, body: StructureRequest):
    ...
    async def tool_call(request: Request, body: ToolCallRequest):
        """Function calling."""
    ...
    async def json_mode(request: Request, body: JsonRequest):
        """JSON mode."""
