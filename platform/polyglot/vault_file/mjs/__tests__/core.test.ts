...
describe("Core Module", () => {
  ...
  describe("fromJSON()", () => {
    describe("Statement Coverage", () => {
      it("should deserialize valid JSON to VaultFile", () => {
        const json =
          '{"header": {"version": "1.0.0", "created_at": "2023-01-01T00:00:00.000Z"}, "secrets": {"KEY": "value"}}';
    ...
    describe("Branch Coverage", () => {
      it("should normalize version on load (1.0 -> 1.0.0)", () => {
        const json =
          '{"header": {"version": "1.0", "created_at": "2023-01-01T00:00:00.000Z"}, "secrets": {}}';
      ...
      it("should normalize single-part version (1 -> 1.0.0)", () => {
        const json =
          '{"header": {"version": "1", "created_at": "2023-01-01T00:00:00.000Z"}, "secrets": {}}';
      ...
      it("should convert snake_case keys to camelCase", () => {
        const json =
          '{"header": {"version": "1.0.0", "created_at": "2023-01-01T00:00:00.000Z"}, "secrets": {}}';
      ...
      it("should handle missing version", () => {
        const json =
          '{"header": {"created_at": "2023-01-01T00:00:00.000Z"}, "secrets": {}}';
  ...
  describe("Integration", () => {
    it("should roundtrip JSON serialization", () => {
      const original: VaultFile = {
        header: {
          version: "2.0.0",
          createdAt: "2023-06-15T10:30:00.000Z",
          description: "Test vault file",
        },
        secrets: { DB_PASSWORD: "********", API_TOKEN: "token456" },
      };
