...
import { EmbeddingClient, DEFAULT_BASE_URL, EMBEDDINGS_PATH, MAX_BATCH_SIZE, getOpenAIKwargs } from '../src/index.mjs';
...
describe('EmbeddingClient', () => {
  ...
  it('should use default base URL', () => {
    ...
    expect(client._endpoint).toBe('https://api.openai.com/v1/embeddings');
  });
  ...
  it('should accept custom base URL', () => {
    ...
    expect(client._endpoint).toBe('https://custom.api.com/v1/embeddings');
  });
  ...
  it('should have embedDocuments method', () => {
    const client = new EmbeddingClient({ model: 'test', apiKey: 'key' });
    expect(typeof client.embedDocuments).toBe('function');
  });

  it('should have embedQuery method', () => {
    const client = new EmbeddingClient({ model: 'test', apiKey: 'key' });
    expect(typeof client.embedQuery).toBe('function');
  });

  it('should have aEmbedQuery method', () => {
    const client = new EmbeddingClient({ model: 'test', apiKey: 'key' });
    expect(typeof client.aEmbedQuery).toBe('function');
  });
});
