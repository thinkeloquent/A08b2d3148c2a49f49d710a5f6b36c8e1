"""
Structured, scoped logger factory for the confluence-api package.
...
- Override via constructor: ConfluenceClient(logger=custom_logger)
"""
...
def create_logger(package_name: str, filename: str) -> _Logger:
    ...
    Args:
        package_name: Package name (e.g. 'confluence-api')
