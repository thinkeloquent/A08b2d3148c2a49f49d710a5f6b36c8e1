 ...
 *
 * const logger = create("cache_json_awss3_storage", __filename);
...
export class DefaultLogger implements Logger {
  ...
  constructor(
    ...
    this.filename = filename ? basename(filename) : "unknown";
 ...
 *
 * @param packageName - Name of the package (e.g., "cache_json_awss3_storage")
 ...
 * @example
 * ```typescript
 * const logger = create("cache_json_awss3_storage", import.meta.url);
