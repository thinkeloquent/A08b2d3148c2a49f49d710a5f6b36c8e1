/**
 * @module logger
 * @description Structured, scoped logger factory for the jira-api package.
 *
 * Usage:
 *   import { createLogger } from './logger.mjs';
 *   const log = createLogger('jira-api', import.meta.url);
 *   log.info('fetching issue', { issueKey: 'PROJ-123' });
 *
 ...
 * - Override via constructor: new JiraClient({ logger: customLogger })
 */
 ...
 *
 * @param {string} packageName - Package name (e.g. 'jira-api')
