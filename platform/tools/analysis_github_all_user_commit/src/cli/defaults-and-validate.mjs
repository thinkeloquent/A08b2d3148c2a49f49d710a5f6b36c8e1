...
export function validateAndNormalize(options) {
  ...
  // Coerce includeDetails to boolean
  if (typeof validated.includeDetails === "string") {
    validated.includeDetails = validated.includeDetails !== "false";
  } else if (validated.includeDetails === undefined) {
    validated.includeDetails = true;
  }
