...
/**
 * Build the full report object for markdown-to-code ratio analysis.
 * @param {object} config - Validated config
 * @param {{ commits: Array, repositories: string[] }} data
 * @param {object} analytics - Results from MarkdownToCodeAnalyzer
...
export function buildReport(config, data, analytics, repositories, { totalFetched, cancelled }) {
  const report = {
    ...
    analytics: {
      ...
      undocumentedRepos: analytics.undocumentedRepos || [],
    },
    commitClassifications: analytics.commitClassifications || [],
    fileClassifications: analytics.fileClassifications || [],
  };
