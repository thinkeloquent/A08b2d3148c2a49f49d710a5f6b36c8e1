 ...
 * @param {object} analytics - Results from PRCycleTimeAnalyzer
...
export function generateSummary(data, analytics) {
  ...
  return {
    ...
    mergeRate: pullRequests.length > 0
      ...
      : 0,
    avgCycleTimeDays: analytics?.summary?.avgCycleTimeDays || 0,
    medianCycleTimeDays: analytics?.summary?.medianCycleTimeDays || 0,
    p90CycleTimeDays: analytics?.summary?.p90CycleTimeDays || 0,
