...
export function validateAndNormalize(options) {
  ...
  // Coerce thresholds to positive numbers
  validated.hotspotThreshold = Math.max(1, parseFloat(validated.hotspotThreshold) || 10);
  validated.topFilesLimit = Math.max(1, parseInt(validated.topFilesLimit, 10) || 50);
