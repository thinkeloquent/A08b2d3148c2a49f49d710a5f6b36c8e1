...
/**
 * Load the workflow definition. Checks storage for an active workflow
 * first; falls back to /graph-workflow.json if none is set.
 */
async function loadWorkflowDef() {
  ...
  const res = await fetch('/graph-workflow.json');
