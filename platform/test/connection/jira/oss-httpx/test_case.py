#!/usr/bin/env python3
"""
Connection test for Jira API via raw open-source httpx library.
...
async def _test_connection(provider_cfg: dict, conn_cfg: dict) -> dict:
    """Test Jira API connection using raw httpx.AsyncClient."""
    email = (
    ...
    try:
        ...
        async with httpx.AsyncClient(
            ...
            return {
                ...
                "has_account_id": "accountId" in result if isinstance(result, dict) else False,
                "latency_ms": latency,
                "connection": {
