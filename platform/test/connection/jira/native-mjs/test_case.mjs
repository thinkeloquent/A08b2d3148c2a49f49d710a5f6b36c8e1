...
/**
 * Connection test for Jira API via Node.js stdlib (node:https).
 *
...
const email = providerConfig.email || process.env.JIRA_EMAIL;
const apiToken = providerConfig.api_token || process.env.JIRA_API_TOKEN;
