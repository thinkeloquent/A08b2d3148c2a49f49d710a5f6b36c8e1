...
/**
 * Connection test for Figma API via the internal fetch_undici package.
 *
...
if (!token) {
  ...
  try {
    ...
    const response = await client.get('https://api.figma.com/v1/me', {
    ...
    connectionTest = {
      ...
      hasUser: typeof body === 'object' && body !== null && 'id' in body,
      latency_ms: latency,
      connection: {
