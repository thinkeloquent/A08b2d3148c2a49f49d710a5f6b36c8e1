#!/usr/bin/env python3
"""
Connection test for Figma API via the internal figma_api SDK.
...
async def _test_connection(provider_cfg: dict, conn_cfg: dict) -> dict:
    """Test Figma API connection using the SDK."""
    token = (
    ...
    base_url = provider_cfg.get("base_url", "https://api.figma.com")
    ...
    try:
        ...
        async with FigmaClient(
            ...
            # Use the /v1/me endpoint as a lightweight health check
            result = await client.get("/v1/me")
