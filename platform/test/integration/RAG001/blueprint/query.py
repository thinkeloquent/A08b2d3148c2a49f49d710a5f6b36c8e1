#!/usr/bin/env python3
"""
Interactive RAG Query Interface for Blueprint (Palantir)
Search components and ask LLM-powered questions against the indexed vector store.

Usage:
    python query.py
    PERSIST_DIRECTORY=db_blueprint LLM_PROVIDER=anthropic python query.py

Environment variables:
    PERSIST_DIRECTORY   - ChromaDB path (default: db_blueprint)
...
SYSTEM_PROMPT = f"""You are an expert on the {LIBRARY_NAME} component library by Palantir. You answer questions
