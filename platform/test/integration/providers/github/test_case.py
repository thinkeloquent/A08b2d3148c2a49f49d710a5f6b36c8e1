#!/usr/bin/env python3
"""Direct package test for github provider auth config with connection check."""
...
def main() -> int:
    ...
    provider_config = app_cfg.get_nested("providers", "github", default={})
    ...
    summary = {
        ...
        "app_yaml_providers_github": provider_config,
        "resolved_config": {
            "base_url": provider_config.get("base_url"),
    ...
    summary["app_yaml_providers_github"] = {k: ("*******" if k in _sensitive else v) for k, v in summary["app_yaml_providers_github"].items()}
