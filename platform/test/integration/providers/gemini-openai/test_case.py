#!/usr/bin/env python3
"""Direct package test for gemini-openai provider auth config with connection check."""
...
def main() -> int:
    ...
    summary["app_yaml_providers_gemini_openai"] = {k: ("*******" if k in _sensitive else v) for k, v in summary["app_yaml_providers_gemini_openai"].items()}
