...
const providerConfig = appConfig.getNested(['providers', 'anthropic'], {});
const authOptions = authConfigMod.buildSdkAuthOptions(providerConfig, 'x-api-key');
...
const summary = {
  ...
  app_yaml_providers_anthropic: providerConfig,
  resolved_config: {
