...
const authOptions = authConfigMod.buildSdkAuthOptions(providerConfig, 'custom_header', 'X-Figma-Token');
const apiKey = authConfigMod.resolveApiKey(providerConfig);

// --- Connection test ---
let connectionTest = { skipped: true, reason: 'no health_endpoint or api_key' };
const healthEndpoint = providerConfig.health_endpoint;
const baseUrl = providerConfig.base_url;
if (healthEndpoint && apiKey) {
  try {
